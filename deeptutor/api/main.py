...
# Market tools
app.include_router(
    paper_forge.router, prefix="/api/v1/paper-forge", tags=["paper-forge"], dependencies=_auth
)
app.include_router(
    exam_grader.router, prefix="/api/v1/exam-grader", tags=["exam-grader"], dependencies=_auth
)
app.include_router(
